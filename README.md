...
**Zad.1 - Układ kodu**<br />
Kod zamieszczony w zadaniu pierwszym ma wiele problemów związanych z układem kodu. Popraw kod, nie zmieniając logiki zadania - wynik działania programu nie może ulec zmianie. Zadanie znajdziesz w pliku [a link](https://github.com/bpajor/CzystyKod/blob/master/zad1/zad1.py). W razie problemów, rozwiązane zadanie znajdziesz w pliku [a link](https://github.com/bpajor/CzystyKod/blob/master/zad1/zad1_fixed.py).
